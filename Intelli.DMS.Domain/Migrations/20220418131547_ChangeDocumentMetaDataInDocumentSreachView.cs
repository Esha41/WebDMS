...
{
    public partial class ChangeDocumentMetaDataInDocumentSreachView : Migration
    {
...
, bi.UpdatedAt 
, bi.IsActive
,(select string_agg( ISNULL(meta.FieldValue, ' '), ',') from dbo.BatchMeta meta where meta.BatchId=bi.BatchId And meta.FileName=bi.FileName) AS DocumentMetaData
