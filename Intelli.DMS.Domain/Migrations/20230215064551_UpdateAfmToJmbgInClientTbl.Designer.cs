...
namespace Intelli.DMS.Domain.Migrations
{
    ...
    [Migration("20230215064551_UpdateAfmToJmbgInClientTbl")]
    partial class UpdateAfmToJmbgInClientTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Client", b =>
                {
                    ...
                    b.HasIndex(new[] { "JMBG" }, "IX_Customer_JMBG")
                        .IsUnique();

                    b.ToTable("Clients");
                });

            modelBuilder.Entity("Intelli.DMS.Domain.Model.ClientCompanyCustomFieldValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ClientCompanyCustomFieldValues");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Company", b =>
                {
                    ...
                    b.Property<string>("ActiveDirectoryDomainName")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("UsersPerCompany")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.CompanyCustomField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DocumentClassFieldTypeId");

                    b.ToTable("CompanyCustomFieldes");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DMSOutLookAddInTempFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DMSOutLookAddInTempFiles");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DataMigrationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DataMigrationReordHistory", b =>
                {
                    b.Property<string>("TableName")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("TableName", "RecordId");

                    b.ToTable("DataMigrationReordHistories");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentCheckOutLogsView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DocumentCheckOutLogsView", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentClassField", b =>
                {
                    ...
                    b.Property<string>("DocumentClassFieldCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentTypeRoleAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DocumentTypeRoleAccess");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Views.ContractSearchView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ContractMetaData")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Views.DocumentSearchView", b =>
                {
                    ...
                    b.Property<string>("CurrentReviewRole")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.ClientCompanyCustomFieldValue", b =>
                {
                    b.HasOne("Intelli.DMS.Domain.Model.Client", "Client")
                        .WithMany("ClientCompanyCustomFieldValues")
                    ...
                    b.HasOne("Intelli.DMS.Domain.Model.CompanyCustomField", "Field")
                        .WithMany()
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.ClientTag", b =>
                {
                    ...
                    b.HasOne("Intelli.DMS.Domain.Model.SystemUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DMSOutLookAddInTempFile", b =>
                {
                    b.HasOne("Intelli.DMS.Domain.Model.SystemUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Client", b =>
                {
                    ...
                    b.Navigation("ClientCompanyCustomFieldValues");
