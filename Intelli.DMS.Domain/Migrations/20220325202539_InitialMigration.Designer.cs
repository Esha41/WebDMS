...
namespace Intelli.DMS.Domain.Migrations
{
    ...
    [Migration("20220325202539_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Batch", b =>
                {
                    ...
                    b.HasIndex(new[] { "CompanyId" }, "IX_Batches_CompanyId");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.BatchItemStatus", b =>
                {
                    ...
                    b.Property<string>("BatchItemStatus1")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.BatchSource", b =>
                {
                    ...
                    b.Property<string>("BatchSource1")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.BatchStatus", b =>
                {
                    ...
                    b.Property<string>("BatchStatus1")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsValidForTransaction")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DictionaryType", b =>
                {
                    ...
                    b.Property<string>("DictionaryType1")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.HasIndex(new[] { "DictionaryType1" }, "IX_DictionaryTypes")
                        .IsUnique();

                    b.ToTable("DictionaryTypes");
                });

            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentClassField", b =>
                {
                    ...
                    b.Property<string>("CorrectiveActionMappedName")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DocumentSubCategoryName")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValueSql("(N'')");
                    ...
                    b.HasIndex(new[] { "DocumentCategoryId" }, "IX_DocumentSubCategories_DocumentCategoryId");

                    b.ToTable("DocumentSubCategories");
                });
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.StationVariableType", b =>
                {
                    ...
                    b.Property<string>("StationVariableType1")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.SystemUsersView", b =>
                {
                    b.Property<int?>("CompanyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.Batch", b =>
                {
                    ...
                    b.HasOne("Intelli.DMS.Domain.Model.Customer", "Customer")
                        .WithMany("Batches")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.BatchMetaHistory", b =>
                {
                    ...
                    b.HasOne("Intelli.DMS.Domain.Model.SystemUser", "SystemUser")
                        .WithMany("BatchMetaHistories")
                        .HasForeignKey("SystemUserId")
                        .HasConstraintName("FK_BatchMetaHistory_SystemUsers");
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentSubCategory", b =>
                {
                    b.HasOne("Intelli.DMS.Domain.Model.DocumentCategory", "DocumentCategory")
                        .WithMany("DocumentSubCategories")
            ...
            modelBuilder.Entity("Intelli.DMS.Domain.Model.DocumentCategory", b =>
                {
                    b.Navigation("DocumentSubCategories");
                });
