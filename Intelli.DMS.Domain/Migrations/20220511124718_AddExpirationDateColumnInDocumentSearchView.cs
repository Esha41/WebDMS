...
{
    public partial class AddExpirationDateColumnInDocumentSearchView : Migration
    {
  ...
  ALTER View [dbo].[DocumentSearchView] As
							...
							,(select string_agg( ISNULL(meta.FieldValue, ' '), ',') from dbo.BatchMeta meta where meta.BatchItemReference=bi.BatchItemReference and (Select DocumentClassFieldTypeId from DocumentClassFields where Id =meta.DocumentClassFieldId)=10) AS ExpirationDate
