...
{
    public partial class SetDocumentSreach_View : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                               DROP VIEW [dbo].[DocumentSearchView];
                    ");
            migrationBuilder.Sql(@"
...
, bi.UpdatedAt 
, bi.IsActive
,(select string_agg( ISNULL(meta.FieldValue, ' '), ',') from dbo.BatchMeta meta where meta.BatchId=bi.BatchId) AS DocumentMetaData
