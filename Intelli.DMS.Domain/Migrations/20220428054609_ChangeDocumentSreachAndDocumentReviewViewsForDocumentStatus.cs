...
{
    public partial class ChangeDocumentSreachAndDocumentReviewViewsForDocumentStatus : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                            ...
                            case 
                               ...
                               then 'Approval Level '+ (SELECT  Cast(Count(*) as varchar) from DocumentApprovalHistory DocAppHis where DocAppHis.BatchItemReference = bi.BatchItemReference And DocAppHis.Approved=1)
